...
#import "LWUIWebViewController.h"
#import <WebKit/WebKit.h>

@interface LWUIWebViewController ()<WKUIDelegate,WKNavigationDelegate>
@property(nonatomic, strong) WKWebView *webView;
@property(nonatomic, strong) UIProgressView *progressView;

@end
@implementation LWUIWebViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    //监听进度
