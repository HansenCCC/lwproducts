...
typedef NS_ENUM(NSUInteger, HVUIFlowLayoutButtonContentStyle) {
    HVUIFlowLayoutButtonContentStyleHorizontal,//左图标,右文本.默认样式
    HVUIFlowLayoutButtonContentStyleVertical,//上图标,下文本
};
@interface HVUIFlowLayoutButton : UIButton{
@protected
	HVUIFlowLayoutConstraint *_flowLayout;
}
@property(nonatomic,assign) HVUIFlowLayoutButtonContentStyle contentStyle;
